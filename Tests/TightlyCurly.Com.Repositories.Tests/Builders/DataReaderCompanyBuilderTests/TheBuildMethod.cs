...
{
    [TestClass]
    public class TheBuildMethod : MsTestMoqDataReaderBuilderTestBase<DataReaderCompanyBuilder, ICompany>
    {
        [TestMethod]
        ...
        public void WillBuildItem()
        {
            TestRunner.ExecuteTest(() =>
                {
                    WillBuildItem<CompanyDataModel>(
                        propertiesToIgnore: new[] {"ParentCompany", "ChildCompanies", "Relationships", 
                        "CompanyType", "Countries", "ContactInfos", "ValueFactories"});
                });
        }
    }
}
