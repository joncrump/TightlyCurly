...
{
    public class DatabaseCompanyPositionRepository : EntityModelDatabaseRepositoryBase<ICompanyPosition, 
        CompanyPositionDataModel>, ICompanyPositionRepository
    {
        public DatabaseCompanyPositionRepository(string databaseName, IDatabaseFactory databaseFactory, 
            IMapper mapper, IQueryBuilder queryBuilder, IBuilderStrategyFactory builderStrategyFactory) 
